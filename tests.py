...
def test():
    ...
    scenario.h4("Race 2 winner:")
    scenario.show(c1.data.races[1].winner)
    scenario.h4("Players balances:")
    scenario.show(c1.data.ledger[player1])
    scenario.show(c1.data.ledger[player2])
    ...
    scenario.h4("Player 1 withdraw money")
